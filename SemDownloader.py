...
def main():
    ...
    parser.add_argument('-o', '--out_dir', required=False, help='directory in which to download')
    ...
    dir_path = '/mnt/user/datasets/scannet'
    ...
    for item in items:
        ...
        if os.path.isdir(item_path):
            ...
            args.out_dir = '/mnt/user/datasets/scannet/'
            args.id = item
            args.type = '_vh_clean.ply'
            ...
            # zip_file_path = item_path + '/' + item + args.type
